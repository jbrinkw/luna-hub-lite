// ============================================================================
// scale-live.ino — Live Shelf firmware (Bundle B)
//
// Wemos D1 Mini + 4x HX711 (shared SCK on D7, DOUTs on D6/D1/D2/D5)
// + WS2812B RGB LED on D4 (GPIO2)
//
...
#define EEPROM_MAGIC 0xBEEF0005UL
...
struct RuntimeCfg {
  ...
  char pi_url[64];
  // Device id sent in payloads (default "scale-01")
  char device_id[24];
...
void handleRoot() {
  ...
  html += "<div class='label'>Shelf Weight (avg of 4 cells)</div>";
...
void setup() {
  Serial.begin(115200);
  delay(100);
  Serial.println("\n=== Live Shelf Scale (4-cell HX711 + WS2812B) ===");
