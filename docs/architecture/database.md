...
| External API calls      | Supabase Edge Functions                                                                                         | Walmart scraping (via third-party scraper API, already implemented), OpenFoodFacts + Claude Haiku 4.5 product analysis, LiveTrack shelf-ingest, LiveTrack pairing sessions                                                                                                                                                                                                                                                                                                              |
