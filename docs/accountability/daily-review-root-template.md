...
> Long-term compass. Update only when it actually changes.

[REPLACE: your 5-year direction. Two or three sentences. e.g.:]

PhD in AI from a top-tier school (Stanford / MIT / CMU / Berkeley).
Research direction: agentic systems or world models.
Fallback: senior research engineer at a frontier lab.

## 2026

> Yearly commits. Edit in place as the year evolves. Closed in late December.

- [ ] Submit 1 conference / workshop paper
- [ ] 5+ meaningful industry connections
- [ ] Complete Karpathy + fast.ai + one advanced course
...
- [ ] Finish Karpathy GPT-from-scratch video
...
- Defense AI (Anduril, Palantir, Shield AI, Rebellion)
- Charlotte NC tech job market
- Minecraft AI research (VPT, MineStudio, STEVE-1 family)
