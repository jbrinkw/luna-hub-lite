              ...
              {SETTINGS_LINKS.map((item, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 w-full px-4 py-3 text-left transition-colors hover:bg-slate-50 ${
                      idx < SETTINGS_LINKS.length - 1 ? 'border-b border-slate-100' : ''
                    }`}
                  >
          ...
          <div className="flex-1">
            ...
            {activationsLoading ? (
              ...
              >
                ...
                <Link
                  to="/hub/apps"
                  className="inline-block rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-blue-700"
                >
